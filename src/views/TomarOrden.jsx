                ...
                ${aderezosDisponiblesBase.map(a => `
                  <div class="flex items-center justify-between p-1 bg-white rounded-lg border">
                    ...
                    <div class="flex items-center gap-1">
                      ...
                      <button class="ade-btn w-6 h-6 bg-blue-600 text-white rounded font-black text-xs" data-plato="${i}" data-ade="${a}" data-type="plus" type="button">+</button>
                    </div>
                  </div>
                `).join('')}
              </div>
      ...
      return `
        <div class="text-left font-sans">
          ...
          <div class="mb-2 text-center">
            <span class="text-[10px] bg-emerald-50 text-emerald-700 border border-emerald-200 font-black uppercase px-3 py-1 rounded-full">
          ...
          <div class="mb-4">
            ...
            <input type="number" id="swal-cant" class="swal2-input !m-0 !w-full" value="${cantidadLocal}" min="1" placeholder="0">
          </div>
